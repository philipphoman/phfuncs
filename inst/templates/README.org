...
# ----------------------------------------------------------------------
#+INCLUDE: header.org src org :exports none :results silent
# ----------------------------------------------------------------------
...
# buffer
#+INCLUDE: elisp-header.el src emacs-lisp :exports none :results silent
# ----------------------------------------------------------------------
*** End preamble                                               :ignore:
# ----------------------------------------------------------------------
...
Change to the root directory and run 'make analysis'.
